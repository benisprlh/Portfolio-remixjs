...
const HeroSection = () => {
    ...
    const [showHero, setShowHero] = useState(false); // State to control hero visibility
    const texts = [
        "Nice to meet you!",
    ...
    // Show hero section after welcome animation is done
    useEffect(() => {
        const welcomeDuration = 1000; // Set time after welcome animation is done (e.g., 4 seconds)
    ...
    // Conditional rendering for hero section
    return (
        <>
            {showHero && (
                <motion.section
